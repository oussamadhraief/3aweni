      ...
      <div className="footer__container g-container">
        <div className="footer__left">
          ...
          <form className="footer__form">
            <input className="footer__form-input" placeholder="Votre adresse email"/>
            <button className="footer__form-submit g-button g-button--submit"> S'abonner
          ...
          <div className="footer__social">
            <Link className="footer__social-link" to=""><img className="footer__social-icon" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/facebook.svg" alt="icon"/></Link>
            <Link className="footer__social-link" to=""><img className="footer__social-icon" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/instagram.svg" alt="icon"/></Link>
            <Link className="footer__social-link" to=""><img className="footer__social-icon" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/youtube.svg" alt="icon"/></Link>
            <Link className="footer__social-link" to=""><img className="footer__social-icon" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/linkedin.svg" alt="icon"/></Link>
            <Link className="footer__social-link" to=""><img className="footer__social-icon" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/tiktok.svg" alt="icon"/></Link></div>
        </div>
