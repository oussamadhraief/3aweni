    ...
    <section className="learning">
      <div className="learning__container g-container">
        <div className="learning__images to-image"><img className="learning__image" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/dots.svg" alt="dots"/>
          <div className='w-fit h-fit bg-white'><picture className="learning__picture bg-w"><img className="learning__picture-image" src="/tutorial-illustration.png" alt="learning"/></picture></div>
          <div className="learning__bubble g-bubble to-right">On vous aide pour que vous aidez</div>
        </div>
        <div className="learning__info to-top"><span className="learning__subtitle">On vous ecoute</span>
          <h2 className="learning__title">Tout ce dont vous avez besoin </h2>
          <p className="learning__description">Nos experts sont prêts à vous guider à chaque étape, n'hésitez pas à nous poser des questions.</p><Link className="learning__button" to="#">Poser une question
