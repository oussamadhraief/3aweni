  ...
  return (
    <section className="started">
      <div className="started__container g-container">
        <picture className="started__picture-left"><img className="started__picture-image" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/started-man.png" alt="man"/></picture>
        <div className="started__info to-top">
          <h2 className="started__title">Get Started Today</h2>
          <p className="started__description">Join the Bello community of people who are securing their financial future.</p>
          <button className="started__button g-button g-button--cta">get my price
        ...
        <picture className="started__picture-right to-left"><img className="started__picture-image" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/started-boy.png" alt="boy"/></picture>
      </div>
    </section>
  )
}
