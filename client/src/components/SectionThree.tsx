  ...
  return (
    ...
    <div className="help__container g-container">
      <div className="help__info to-top"><span className="help__subtitle to-image">Technology meets service</span>
        ...
        <p className="help__description">Bella, our smart bot, can guide you to your perfect policy. There’s also human help whenever you need it.</p><a className="help__button" href="#">get help
