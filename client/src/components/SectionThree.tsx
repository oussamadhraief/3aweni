...
export default function SectionThree() {
  return (
    ...
    <div className="help__container g-container">
      <div className="help__info to-top"><span className="help__subtitle to-image">Technology meets service</span>
        <h2 className="help__title">We're here to help</h2>
        <p className="help__description">Bella, our smart bot, can guide you to your perfect policy. There’s also human help whenever you need it.</p><Link className="help__button" to="#">get help
      ...
      <div className="help__images"><img className="help__image" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/dots.svg" alt="dots"/>
        <picture className="help__picture"><img className="help__picture-image to-image" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/help-image.png" alt="help"/></picture><span className="help__bubble g-bubble to-right">There's also human help 👋</span>
      </div>
    </div>
  </section>
  )
