...
export default function New3aweniCategoryGoal({handleChange, Form, handleScroll} : {handleChange:(e: FormEvent) => void, Form: FormState, handleScroll: (index: number) => void}) {

    
  return (
    <div className='w-fit h-fit min-w-screen min-h-screen overflow-hidden items-start relative flex flex-nowrap shrink-0'>

    <aside className='w-1/3 h-screen  bg-[#f9f5f2] create-aside-background relative flex justify-center'>
        <Link to='/' className='w-32 h-32 absolute left-10 top-10'> 
