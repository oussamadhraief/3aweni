  ...
  return (
    <section className="hero">
      <div className="hero__info to-top">
        ...
        <p className="hero__description">Rendre le monde meilleur, par un simple don.</p>
        <Link to="/create/category" className="hero__button g-button g-button--cta">Lancer un 3aweni
      ...
      <video className="hero__video" autoPlay muted loop>
        <source className="hero__source" src="https://raw.githubusercontent.com/ricardoolivaalonso/GetBello/main/public/img/hero-video.webm" type="video/webm"/>
      </video>
    </section>
  )
}
