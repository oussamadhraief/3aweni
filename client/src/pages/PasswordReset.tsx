  ...
  return (
        ...
        <form className="w-1/3 min-w-[300px] max-w-[500px] flex flex-col items-center justify-center" onSubmit={handleSubmit}>
            ...
            <div className="relative my-[15px] w-full">
                <input type="password" className="peer block w-full h-10 bg-transparent border  border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-main_color valid:border-main_color" name="password" required onChange={handleChange} />
            ...
            <div className="relative my-[15px] w-full">
                <input type="password" className="peer block w-full h-10 bg-transparent border  border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-main_color valid:border-main_color" name="password-confirmation" required onChange={handleChange} />
            ...
            <button className="w-fit h-fit px-8 py-2 bg-secondary_color text-white rounded my-7"> Mettre à jour </button>
