    ...
    <aside className='w-1/3 h-screen bg-beige create-aside-background relative flex justify-center'>
      ...
      <div className='w-2/3 h-screen bg-white z-10 rounded-tl-[46px] shadow-modern px-10 pb-10 overflow-auto pt-32 flex items-center flex-col justify-between'>
        ...
        <div className="w-3/6 min-w-[300px] flex flex-col items-center justify-center gap-8 mt-10">
            <p>Vous êtes déjà inscrit ? <Link to='/create/login' className='underline text-primary'>Se connecter</Link></p>
            
            <div className='flex w-full justify-between items-center gap-4'>
            
            <div className="relative w-1/2">
                <input type="text" className="peer block w-full h-10 bg-transparent border rounded border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-primary valid:border-primary" id="lastName" name="lastName" required onChange={handleChange} value={Form.lastName} />
            ...
            <div className="relative w-1/2">
                <input type="text" className="peer block w-full h-10 bg-transparent border rounded border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-primary valid:border-primary" id="firstName" name="firstName" required value={Form.firstName} onChange={handleChange} />
            ...
            <div className="relative w-full">
                <input type="text" className="peer block w-full h-10 bg-transparent border rounded border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-primary valid:border-primary" id="phone" name="phone" required onChange={handleChange} />
            ...
            <div className="relative w-full">
                <input type="text" className="peer block w-full h-10 bg-transparent border rounded border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-primary valid:border-primary" id="email" name="email" required onChange={handleChange} />
            ...
            <div className="relative w-full">
                <input type="text" className="peer block w-full h-10 bg-transparent border rounded border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-primary valid:border-primary" id="password" name="password" required onChange={handleChange} />
            ...
            <div className="relative w-full">
                <input type="text" className="peer block w-full h-10 bg-transparent border rounded border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-primary valid:border-primary" id="password-confirm" name="password-confirm" required onChange={handleChange} />
