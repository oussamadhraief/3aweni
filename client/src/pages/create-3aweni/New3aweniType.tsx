        ...
        <div className='w-5/6 mt-20'>
          ...
          <p>Pour qui voulez-vous collecter les fonds:</p> 
            <div className='w-5/6 flex justify-start gap-4 items-center flex-wrap mt-8'>
              ...
              <label className={Form.type == "Forme" ? 'w-full relative flex justify-between items-center h-28 px-4 py-5 bg-lighter_primary border-2 border-primary hover:cursor-pointer rounded-lg' : 'w-full relative flex justify-between items-center h-28 px-4 py-5 bg-white shadow-form hover:bg-lighter_primary hover:border-lighter_primary hover:cursor-pointer rounded-lg border border-white'} htmlFor="Forme"> <input type="radio" name="category" id="Forme" className='absolute -z-10 rounded' onChange={e => handleChange(e)} required value="Forme" checked={Form.type === "Forme"} />
                <div>
                  <p>Pour moi</p> 
              ...
              <label className={Form.type == "Forsomeone" ? 'w-full relative flex justify-between items-center h-28 px-4 py-5 bg-lighter_primary border-2 border-primary hover:cursor-pointer rounded-lg' : 'w-full relative flex justify-between items-center h-28 px-4 py-5 bg-white shadow-form hover:bg-lighter_primary hover:border-lighter_primary hover:cursor-pointer rounded-lg border border-white'} htmlFor="Forsomeone"> <input type="radio" name="category" id="Forsomeone" className='absolute -z-10 rounded' onChange={e => handleChange(e)} required value="Forsomeone" checked={Form.type === "Forsomeone"} />
                <div>
