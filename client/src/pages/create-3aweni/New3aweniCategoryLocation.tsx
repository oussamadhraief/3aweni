          ...
          <div className="w-5/6">
            ...
            <div className="w-full h-fit flex flex-nowrap justify-start items-start gap-5 mt-3">
              ...
              <div className="relative w-full xl:w-96">
                <input
                  type="number"
                  className="peer block w-full h-10 bg-transparent border  border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-primary valid:border-primary rounded-lg"
                  name="zipCode"
                  id="zipCode"
                  required
                  value={Form.zipCode || ""}
