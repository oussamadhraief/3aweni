    ...
    <main className="mt-[94px] flex justify-center items-center py-32">
        ...
        <form className="w-1/3 min-w-[300px] max-w-[500px] flex flex-col items-center justify-center" onSubmit={handleSubmit}>
          ...
          <div className="relative my-[15px] w-1/2">
              <input type="text" className="peer block w-full h-10 bg-transparent border  border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-main_color valid:border-main_color" id="lastName" name="lastName" required onChange={handleChange} />
          ...
          <div className="relative my-[15px] w-full">
              ...
              <label htmlFor="phone" className="absolute peer-focus:text-xs peer-focus:-top-[5px] peer-focus:outline-none bg-white peer-focus:text-main_color border-0 outline-none peer-valid:text-main_color peer-valid:text-xs peer-valid:-top-[5px] peer-valid:outline-none cursor-text z-10 top-[11px] left-2 text-sm font-medium px-[10px] text-[rgb(80,80,80)] transition-all">Num. de tél (optionel)</label>
          </div>
