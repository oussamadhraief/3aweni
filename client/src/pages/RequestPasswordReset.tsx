  ...
  return (
        ...
        <form className="w-1/3 min-w-[300px] max-w-[500px] flex flex-col items-center justify-center" onSubmit={handleSubmit}>
            ...
            <div className="relative my-[15px] w-full">
                <input type="email" className="peer block w-full h-10 bg-transparent border  border-[#ccc] transition-all px-[15px] outline-none z-0 focus:border-main_color valid:border-main_color" name="email" required onChange={e => setRequestPasswordResetForm(e.target.value)} />
