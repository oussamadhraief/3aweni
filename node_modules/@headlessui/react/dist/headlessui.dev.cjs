...
var Input = forwardRefWithAs(function Input2(props, ref) {
  ...
  let d = useDisposables();
  let currentValue = (0, import_react18.useMemo)(() => {
    var _a3;
  ...
  let ourProps = {
    ...
    defaultValue: (_d = (_c = props.defaultValue) != null ? _c : displayValue == null ? void 0 : displayValue(data.defaultValue)) != null ? _d : data.defaultValue,
